...
public class UIManager : MonoBehaviour
{
    ...
    public void HandleTileSelection(TileExpansion tile)
    {
        ...
        // Envía evento de Analytics inmediatamente (opcional, para acumulativo comenta esta línea)
        AnalyticsManager.Instance.RecordTilesChosen(new List<string> { tile.tileName });
